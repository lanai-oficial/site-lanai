...
export default function Home() {
  return <>
    ...
    <section className="home-about"><div className="home-about-image"><Image src={lanaiImages.facadeWide} alt="Fachada da Lanai no Shopping Downtown" fill sizes="(max-width: 800px) 100vw, 62vw" /></div><div className="home-about-copy"><p className="eyebrow">Lanai</p><h2>Um espaço para desacelerar.</h2><Link className="text-link" href="/sobre">Conheça a Lanai →</Link></div></section>
